...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "colco.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "colco.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'colco'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'colco':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        ...
        initialize: function( instance ) {
            ...
            Module.exports.initialize = function initialize(element_id, mol, render_settings) {
    Module.instance.exports.initialize(Module.STDWEB_PRIVATE.prepare_any_arg(element_id), Module.STDWEB_PRIVATE.prepare_any_arg(mol), Module.STDWEB_PRIVATE.prepare_any_arg(render_settings));
}
;
            __web_on_grow();
